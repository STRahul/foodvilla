...
const RestaurantCard = ({
  ...
  return (
    <div className="m-4 md:m-2 px-4 py-2 group">
      <img
        className="h-36 md:h-40 w-full rounded-xl shadow-xl group-hover:rounded-none group-hover:scale-105 duration-150"
        src={IMG_URL + cloudinaryImageId}
        alt="res-image"
      />
      <h1 className="text-xl font-bold mt-2 ml-3">{name}</h1>
      <div className="flex items-center gap-2 font-bold mx-3">
        <div>
          <svg
            width="20"
            height="20"
